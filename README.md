...
### This is slightly modified version of PwnFox compatible with [EvenBetter](https://github.com/bebiksior/EvenBetter). It's modified to provide container color within query parameter instead of header. Also, I've added a new checkbox to colorize top level navigation (it's not perfect yet, it sends two requests one without the color parmeter and then second with the color parameter).
